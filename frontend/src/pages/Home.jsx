...
export default function Home() {
  const [books, setBooks] = useState([]); // Always starts as an empty array
  ...
  useEffect(() => {
    const fetchBooks = async () => {
      try {
        ...
        const fetchedBooks = response?.data?.data || []; // Fallback to empty array if undefined
  ...
  // Safeguard: Ensure that books is always an array
